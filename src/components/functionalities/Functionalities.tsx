    ...
    <>
      <div className='flex flex-col'>
        <div className='flex bg-red-400'>
          ...
          <Link to={"/functionalities/create"} className='p-2 hover:bg-red-700 transition-colors'>Add functionality</Link>
        </div>
        ...
        <div className='flex gap-5 mt-5 ml-3'>
          ...
          <span onClick={() => setSelectedStatus(1)} className={selectedStatus == 1 && 'select-none text-white bg-yellow-500 border-yellow-500 px-5 py-1 font-mono text-xl border-2  border-solid rounded-3xl cursor-pointer hover:bg-yellow-500 hover:text-white' || 'select-none text-yellow-500 border-yellow-500 px-5 py-1 font-mono text-xl border-2  border-solid rounded-3xl cursor-pointer hover:bg-yellow-500 hover:text-white'}>DOING</span>
          <span onClick={() => setSelectedStatus(2)} className={selectedStatus == 2 && 'select-none text-white bg-green-500 border-green-500 px-5 py-1 font-mono text-xl border-2  border-solid rounded-3xl cursor-pointer hover:bg-green-500 hover:text-white' || 'select-none text-green-500 border-green-500 px-5 py-1 font-mono text-xl border-2  border-solid rounded-3xl cursor-pointer hover:bg-green-500 hover:text-white'}>DONE</span>
        </div>
        ...
        { !isFetching &&
          <div className='grid grid-cols-5 auto-rows-fr gap-3 m-3'>
            {isUpdated && selectedStatus == -1 && functionalities.map((functionality) => functionality.project == activeProject?.id && <Functionality key={functionality.id} data={functionality} updateState={isUpdated} updateHandler={updateHandler} />)}
            {isUpdated && selectedStatus == 0 && functionalities.map((functionality) => functionality.project == activeProject?.id && functionality.status == 0 && <Functionality key={functionality.id} data={functionality} updateState={isUpdated} updateHandler={updateHandler} />)}
            {isUpdated && selectedStatus == 1 && functionalities.map((functionality) => functionality.project == activeProject?.id && functionality.status == 1 && <Functionality key={functionality.id} data={functionality} updateState={isUpdated} updateHandler={updateHandler} />)}
            {isUpdated && selectedStatus == 2 && functionalities.map((functionality) => functionality.project == activeProject?.id && functionality.status == 2 && <Functionality key={functionality.id} data={functionality} updateState={isUpdated} updateHandler={updateHandler} />)}
          </div>
        }
      </div>
    </>
